    ...
    return (
        <nav className=' font-poppins flex justify-between items-center h-20 border-b-2 border-gray-400'>
            ...
            <ul className='flex items-center space-x-10 px-10 text-lg '>
                ...
                <li>
                    <Link to="/quiz-page" className='hover:underline hover:decoration-cyan-700 hover:decoration-2 hover:underline-offset-[6px] hover:font-semibold ' > Take Quiz</Link>
                </li>
                <li>
